...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        emp_rec = recession_data.groupby(['unemployment_rate','Vehicle_Type'], as_index=False)['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure = px.bar(emp_rec, 
            x='unemployment_rate', 
            y='Automobile_Sales',
            color='Vehicle_Type',
            title = 'Unemployment Rates on Automobile Sales by Vehicle Type During Recession'
            )
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(
            ...
            x='Month',
            y='Automobile_Sales',
            title=f'Average Monthly Automobile Sales for the Year {selected_year}'
            )
        )
...
# Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            title=f'Total Expenditure Share by Vehicle Type in Year {selected_year}'
            )
        )
